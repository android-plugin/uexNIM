...
import org.zywx.wbpalmstar.plugin.uexnim.http.NimHttpClient;
...
public class ContactHttpClient {
     ...
     */
    public void register(Context context, String account, String nickName, String password, final ContactHttpCallback<Void> callback) {
        String url = "https://app.netease.im/api/" + API_NAME_REGISTER;
        try {
...
//            if (appInfo != null) {
//                Log.i(TAG, "registerUser, appKey:" + appInfo.metaData.getString("com.netease.nim.appKey"));
...
//        }
       // return null;
        return "45c6af3c98409b18a84451215d0bdd6e";
    }
}